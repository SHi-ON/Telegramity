...
public class JalaliCalendar implements Serializable {
     ...
     * Farvardin = 0
     */
    public static Calendar getJalaliCalendar(Calendar gre) {
        Calendar jalaliCalendar = gre.getInstance();
        jalaliCalendar.set(getPersianYear(gre.getTime()),
    ...
    private void syncJalaliCalendarWithGregorian() {
    ...
    public void syncGregorianWithJalaliCalendar() {
    ...
    public JalaliCalendar() {
        this.setJalaliCalendarWithJalali(1390, 1, 1);
    }
    ...
    public JalaliCalendar(String jalaliString) {
        ...
        this.setJalaliCalendarWithJalali(Integer.parseInt(part[2]), Integer.parseInt(part[1]),
                Integer.parseInt(part[0]));
    }

    public JalaliCalendar(JalaliCalendar jalali) {
        setJalaliCalendarWithJalali(jalali.getYear(), jalali.getMonth(), jalali.getDay(),
                jalali.getHour(), jalali.getMinute(), jalali.getSecond());
    }

    public JalaliCalendar(int jalaliyear, int jalalimonth, int jalaliday) {
        this.setJalaliCalendarWithJalali(jalaliyear, jalalimonth, jalaliday);
    }

    public JalaliCalendar(int jalaliyear, int jalalimonth, int jalaliday, int jalalihour,
                           int jalalimintute, int jalalisecond) {
        setJalaliCalendarWithJalali(jalaliyear, jalalimonth, jalaliday, jalalihour,
                jalalimintute, jalalisecond);
    }

    public void setJalaliCalendarWithJalali(int year, int month, int dayOfMonth, int hour,
    ...
    public void setJalaliCalendarWithJalali(int year, int month, int dayOfMonth) {
        _year = year;
        _month = month;
        _dayOfMonth = dayOfMonth;
        _hour = 0;
    ...
    public void setJalaliCalendar(Calendar gregorian) {
    ...
    public Calendar getGregorianCalendar() {
        syncGregorianWithJalaliCalendar();
    ...
    public void add(int field, int value) {
        ...
        syncJalaliCalendarWithGregorian();
    }
