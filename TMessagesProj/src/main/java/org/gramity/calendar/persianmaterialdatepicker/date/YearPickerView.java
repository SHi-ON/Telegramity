...
import org.gramity.calendar.persianmaterialdatepicker.date.PersianDatePickerDialog.OnDateChangedListener;
...
public class YearPickerView extends ListView implements OnItemClickListener, OnDateChangedListener {
    ...
    private void init(Context context) {
        ...
        years = GramityUtilities.getPersianNumbering(years);
        ...
        if (clickedView != null) {
            if (clickedView != mSelectedView) {
                if (mSelectedView != null) {
                    ...
                    mSelectedView.setTypeface(AndroidUtilities.getTypeface(null));
                }
    ...
    private static int getYearFromTextView(TextView view) {
        return Integer.valueOf(GramityUtilities.getLatinNumbering(view.getText().toString()));
    }
    ...
    private class YearAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            v.setTypeface(AndroidUtilities.getTypeface(null));
            v.requestLayout();
