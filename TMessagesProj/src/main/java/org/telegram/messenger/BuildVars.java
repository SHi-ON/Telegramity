...
public class BuildVars {
    ...
    public static int BUILD_VERSION = 7071; //2 LOWER than defaultConfig.versionCode
    public static String BUILD_VERSION_STRING = "3.13"; //increment after each upgrading!
...
//    public static String GCM_SENDER_ID = "760348033672";
    public static String SEND_LOGS_EMAIL = "shawn@azdam.com";
