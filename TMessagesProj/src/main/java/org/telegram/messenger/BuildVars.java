...
public class BuildVars {
    ...
    public static int BUILD_VERSION = 7400; //2 LOWER than defaultConfig.versionCode
    public static String BUILD_VERSION_STRING = "3.18"; //increment after each upgrading!
    ...
    public static String HOCKEY_APP_HASH = "b3921fd303a8492185b9ddd87b963feb";
