...
//                            sp.setSpan(new TypefaceSpan(Typeface.DEFAULT), start, end, 0);
                            sp.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface(null)), start, end, 0);
                            messageText = sp;
                        }
                    }
        ...
        if (messageText instanceof Spannable) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (entity instanceof TLRPC.TL_messageEntityBold) {
                    spannable.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface("fonts/IRANSansMobileBold.ttf")), entity.offset, entity.offset + entity.length, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
