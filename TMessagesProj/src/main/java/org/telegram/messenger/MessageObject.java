...
public class MessageObject {
    ...
    public void measureInlineBotButtons() {
        ...
        if (botButtonPaint == null) {
            ...
            botButtonPaint.setTypeface(AndroidUtilities.getTypeface());
        }
        ...
        if (messageText instanceof Spannable) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (entity instanceof TLRPC.TL_messageEntityBold) {
                    spannable.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface()), entity.offset, entity.offset + entity.length, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
