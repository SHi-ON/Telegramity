...
//        addView(imageView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, (LocaleController.isRTL ? Gravity.RIGHT : Gravity.LEFT) | Gravity.CENTER_VERTICAL, LocaleController.isRTL ? 0 : 16, 0, LocaleController.isRTL ? 16 : 0, 0)); //TGY prev ver
    ...
    public void setTextAndValueAndIcon(String text, String value, Drawable resDrawable, int offset) {
        textView.setText(text);
        valueTextView.setText(value);
