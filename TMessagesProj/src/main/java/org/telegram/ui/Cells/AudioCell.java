...
public class AudioCell extends FrameLayout {
    ...
    public AudioCell(Context context) {
        ...
        genreTextView.setTypeface(AndroidUtilities.getTypeface(null));
        ...
        authorTextView.setTypeface(AndroidUtilities.getTypeface(null));
        ...
        timeTextView.setTypeface(AndroidUtilities.getTypeface(null));
