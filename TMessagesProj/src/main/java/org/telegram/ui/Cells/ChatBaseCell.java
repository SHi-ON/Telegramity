...
public class ChatBaseCell extends BaseCell implements MediaController.FileDownloadProgressListener {
    ...
    public ChatBaseCell(Context context) {
        ...
        if (timePaint == null) {
            ...
            replyNamePaint.setTypeface(AndroidUtilities.getTypeface());
            ...
            urlPaint = new Paint();
            urlPaint.setTypeface(AndroidUtilities.getTypeface());
        ...
        if (authorName || viaBot) {
            ...
            if (viaBot) {
                ...
                if (currentNameString.length() > 0) {
                    ...
                    stringBuilder.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface(), 0, currentMessageObject.isOutOwner() ? 0xff4a923c : 0xff006fc8), nameStringFinal.length() + 5, stringBuilder.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    ...
                    stringBuilder.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface(), 0, currentMessageObject.isOutOwner() ? 0xff4a923c : 0xff006fc8), 4, stringBuilder.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    nameStringFinal = stringBuilder;
                }
            }
            try {
