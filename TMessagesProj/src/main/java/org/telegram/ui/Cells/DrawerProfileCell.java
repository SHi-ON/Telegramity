...
//    private TextView onlineTextView; //TGY
    ...
    public DrawerProfileCell(Context context) {
        ...
        if (advancedPrefs.getBoolean(GramityConstants.PREF_DATE_SOLAR_CALENDAR, true)) {
            ...
            dateView.setText(LocaleController.formatDateProfile(System.currentTimeMillis()));
            dateView.setTextColor(Theme.getColor(Theme.key_chats_menuName));
            dateView.setTypeface(AndroidUtilities.getTypeface(null));
            dateView.setLines(1);
...
//        addView(dateView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT, Gravity.RIGHT | Gravity.TOP, 76, 9, 16, 9));
            addView(dateView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT, Gravity.RIGHT | Gravity.BOTTOM, 100, 20, 0, 120));
        }
        //
        ...
        phoneTextView.setTypeface(AndroidUtilities.getTypeface(null));
...
//            onlineTextView.setTextColor(Theme.getColor(Theme.key_chats_menuPhone));
...
//            onlineTextView.setTextColor(Theme.getColor(Theme.key_chats_menuPhoneCats));
            super.onDraw(canvas);
        }
    }
    ...
    public void setUser(TLRPC.User user) {
        ...
        /*boolean specter = preferences.getBoolean(GramityConstants.PREF_SPECTER_MODE, false);
        if (specter) {
        ...
        boolean showingNumber = preferences.getBoolean(GramityConstants.PREF_PRIVACY_NO_NUMBER, true);
        if (showingNumber) {
