...
public class ProfileActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(Context context) {
        SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("AdvancedPreferences", Activity.MODE_PRIVATE);
        int instanceOfProfileBackgroundColor = preferences.getInt("profileBackgroundColor", TelegramityUtilities.colorPBG());
        ...
        listView.setGlowColor(user_id != 0 || ChatObject.isChannel(chat_id) && !currentChat.megagroup ? instanceOfProfileBackgroundColor : AvatarDrawable.getProfileBackColorForId(chat_id));
//        listView.setGlowColor(AvatarDrawable.getProfileBackColorForId(user_id != 0 || ChatObject.isChannel(chat_id) && !currentChat.megagroup ? instanceOfProfileBackgroundColor : chat_id));
        ...
        topView.setBackgroundColor(instanceOfProfileBackgroundColor);
        ...
        adminTextView.setTypeface(AndroidUtilities.getTypeface());
        ...
        if (user_id != 0 || chat_id >= 0 && !ChatObject.isLeftFromChat(currentChat)) {
            ...
            if (user_id != 0) {
                writeButton.setImageDrawable(new IconicsDrawable(context, FontAwesome.Icon.faw_comment).sizePx(40).color(0xff00bcd4)); //Cyan
    ...
    private void leaveChatPressed() {
        ...
        if (ChatObject.isChannel(chat_id) && !currentChat.megagroup) {
            if (currentChat != null && TelegramityUtilities.OFFICIAL_CHAN.equalsIgnoreCase(currentChat.username)) {
    ...
    public void setAnimationProgress(float progress) {
        ...
        int instanceOfActionBarBackgroundColor = themePreferences.getInt("actionBarBackgroundColor", TelegramityUtilities.colorABBG());
        ...
        int color = user_id != 0 || ChatObject.isChannel(chat_id) && !currentChat.megagroup ? instanceOfProfileBackgroundColor : AvatarDrawable.getProfileBackColorForId(chat_id);
//        int color = AvatarDrawable.getProfileBackColorForId(user_id != 0 || ChatObject.isChannel(chat_id) && !currentChat.megagroup ? aBBackgroundColor : chat_id);

        int r = Color.red(instanceOfActionBarBackgroundColor);
        int g = Color.green(instanceOfActionBarBackgroundColor);
        int b = Color.blue(instanceOfActionBarBackgroundColor);
    ...
    private void updateProfileData() {
        ...
        if (user_id != 0) {
            ...
            for (int a = 0; a < 2; a++) {
                ...
                } else if (user.verified || TelegramityUtilities.OFFICIAL_CHAN.equalsIgnoreCase(user.username)) {
        ...
        if (user_id != 0) {
            ...
            if (chat_id > 0) {
                ...
                if (writeButton != null) {
                    boolean isChannel = ChatObject.isChannel(currentChat);
                    if (isChannel && !currentChat.creator && (!currentChat.megagroup || !currentChat.editor) || !isChannel && !currentChat.admin && !currentChat.creator && currentChat.admins_enabled) {
                        writeButton.setImageDrawable(new IconicsDrawable(ApplicationLoader.applicationContext, FontAwesome.Icon.faw_comment).sizePx(40).color(0xff00bcd4)); //Cyan
                        writeButton.setPadding(0, AndroidUtilities.dp(3), 0, 0);
                    } else {
                        writeButton.setImageDrawable(new IconicsDrawable(ApplicationLoader.applicationContext, FontAwesome.Icon.faw_camera).sizePx(40).color(0xff8e6455)); //Brown +2
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2:
                    ...
                    if (i == phoneRow) {
                        ...
                        textDetailCell.setTextAndValueAndIcon(text, LocaleController.getString("PhoneMobile", R.string.PhoneMobile), new IconicsDrawable(mContext, FontAwesome.Icon.faw_phone).sizePx(48).color(0xff47a34b)); //Green -1
                ...
                case 3:
                    ...
                    if (i == sharedMediaRow) {
                        ...
                        if (user_id != 0 && UserConfig.getClientUserId() == user_id) {
                            textCell.setTextAndValueAndIcon(LocaleController.getString("DocumentsTitle", R.string.DocumentsTitle), value, R.drawable.profile_list);
                        } else {
                        ...
                        if (user_id != 0 && UserConfig.getClientUserId() == user_id) {
                            textCell.setTextAndValueAndIcon(LocaleController.getString("AudioTitle", R.string.AudioTitle), value, R.drawable.profile_list);
                        } else {
                        ...
                        if (user_id != 0 && UserConfig.getClientUserId() == user_id) {
                            textCell.setTextAndValueAndIcon(LocaleController.getString("LinksTitle", R.string.LinksTitle), value, R.drawable.profile_list);
                        } else {
                        ...
                        textCell.setTextAndIcon(LocaleController.getString("NotificationsAndSounds", R.string.NotificationsAndSounds), new IconicsDrawable(mContext, FontAwesome.Icon.faw_bell).sizePx(48).color(0xfff22516)); //Red -2
                ...
                case 8:
                    ...
                    if (i == userInfoRow) {
                        ...
                        //aboutLinkCell.setTextAndIcon(about,  new IconicsDrawable(mContext, FontAwesome.Icon.faw_info_circle).sizePx(48).color(0xff4caf50)); //Green
                        aboutLinkCell.setTextAndIcon(about == null ? userAbout : about, new IconicsDrawable(mContext, FontAwesome.Icon.faw_info_circle).sizePx(48).color(0xff4caf50)); //Green
                    } else if (i == channelInfoRow) {
                        String text = info.about;
                        while (text.contains("\n\n\n")) {
                            text = text.replace("\n\n\n", "\n\n");
                        }
                        aboutLinkCell.setTextAndIcon(text, new IconicsDrawable(mContext, FontAwesome.Icon.faw_info_circle).sizePx(48).color(0xffff9800)); //Orange
                    }
                    break;
                default:
