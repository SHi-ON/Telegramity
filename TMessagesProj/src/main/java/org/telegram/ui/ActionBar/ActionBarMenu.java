...
public class ActionBarMenu extends LinearLayout {
    ...
    public ActionBarMenuItem addItemWithDrawableWidth(int id, int icon, Drawable drawable, int width) {
        return addItem(id, icon, isActionMode ? parentActionBar.itemsActionModeBackgroundColor : parentActionBar.itemsBackgroundColor, drawable, width);
    }
