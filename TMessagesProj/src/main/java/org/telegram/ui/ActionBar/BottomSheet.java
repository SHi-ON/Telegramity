...
public class BottomSheet extends Dialog {
    ...
    private Drawable[] itemIcons; // TGY
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public void setTextAndIcon(CharSequence text, Drawable icon) { //TGY
            textView.setText(text);
//            if (icon != 0) {
            if (icon != null) { // TGY
//                imageView.setImageResource(icon);
                imageView.setImageDrawable(icon); // TGY
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (customView != null) {
            ...
            if (title != null) {
                ...
                titleView.setTypeface(AndroidUtilities.getTypeface(null));
...
//                    cell.setTextAndIcon(items[a], itemIcons != null ? itemIcons[a] : 0);
                    cell.setTextAndIcon(items[a], itemIcons != null ? itemIcons[a] : null); // TGY
    ...
    public static class Builder {
        ...
        public Builder setItems(CharSequence[] items, Drawable[] icons, final OnClickListener onClickListener) { // TGY
            bottomSheet.items = items;
