...
public class PhotoFilterView extends FrameLayout {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation) {
        ...
        cancelTextView.setTypeface(AndroidUtilities.getTypeface());
        ...
        doneTextView.setTypeface(AndroidUtilities.getTypeface());
        ...
        infoTextView.setTypeface(AndroidUtilities.getTypeface());
        ...
        paramTextView.setTypeface(AndroidUtilities.getTypeface());
        ...
        for (int a = 0; a < 4; a++) {
            ...
            curveTextView[a].setTypeface(AndroidUtilities.getTypeface());
        ...
        tintShadowsButton.setTypeface(AndroidUtilities.getTypeface());
        ...
        tintHighlightsButton.setTypeface(AndroidUtilities.getTypeface());
        ...
        blurOffButton.setTypeface(AndroidUtilities.getTypeface());
        ...
        blurRadialButton.setTypeface(AndroidUtilities.getTypeface());
        ...
        blurLinearButton.setTypeface(AndroidUtilities.getTypeface());
