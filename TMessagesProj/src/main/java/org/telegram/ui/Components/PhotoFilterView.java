...
public class PhotoFilterView extends FrameLayout {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation) {
        ...
        cancelTextView.setTypeface(AndroidUtilities.getTypeface(null));
        ...
        doneTextView.setTypeface(AndroidUtilities.getTypeface(null));
        ...
        paramTextView.setTypeface(AndroidUtilities.getTypeface(null));
        ...
        for (int a = 0; a < 4; a++) {
            ...
            curveTextView[a].setTypeface(AndroidUtilities.getTypeface(null));
        ...
        tintShadowsButton.setTypeface(AndroidUtilities.getTypeface(null));
        ...
        tintHighlightsButton.setTypeface(AndroidUtilities.getTypeface(null));
        ...
        blurOffButton.setTypeface(AndroidUtilities.getTypeface(null));
        ...
        blurRadialButton.setTypeface(AndroidUtilities.getTypeface(null));
        ...
        blurLinearButton.setTypeface(AndroidUtilities.getTypeface(null));
    ...
    private int calculateMaxToolCellWidth() {
        ...
        paint.setTypeface(AndroidUtilities.getTypeface(null));
