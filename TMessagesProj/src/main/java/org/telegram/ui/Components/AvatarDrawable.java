...
public class AvatarDrawable extends Drawable {
    ...
    private static int[] arrColorsProfilesBack = {0xffca6056, 0xfff18944, 0xff7d6ac4, 0xff56a14c, 0xff4492ac, ApplicationLoader.PBG_COLOR, 0xff7d6ac4, ApplicationLoader.PBG_COLOR};
