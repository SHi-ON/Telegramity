...
public class IntroActivity extends Activity implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        frameLayout.addView(startMessagingButton, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM, 10, 0, 10, 156)); //TGY edited 4.6: bottom margin 76 to 126
        ...
        //TGY 4.6
        changeLanguageButton = new TextView(this);
        changeLanguageButton.setText(LocaleController.getCurrentLanguageName());
        changeLanguageButton.setGravity(Gravity.CENTER);
        changeLanguageButton.setTextColor(0xffffffff);
        changeLanguageButton.setTypeface(AndroidUtilities.getTypeface(null));
        changeLanguageButton.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 15);
        changeLanguageButton.setBackgroundResource(R.drawable.regbtn_states);
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            StateListAnimator animator = new StateListAnimator();
            animator.addState(new int[]{android.R.attr.state_pressed}, ObjectAnimator.ofFloat(changeLanguageButton, "translationZ", AndroidUtilities.dp(2), AndroidUtilities.dp(4)).setDuration(200));
            animator.addState(new int[]{}, ObjectAnimator.ofFloat(changeLanguageButton, "translationZ", AndroidUtilities.dp(4), AndroidUtilities.dp(2)).setDuration(200));
            changeLanguageButton.setStateListAnimator(animator);
        }
        changeLanguageButton.setPadding(AndroidUtilities.dp(20), AndroidUtilities.dp(10), AndroidUtilities.dp(20), AndroidUtilities.dp(10));
        frameLayout.addView(changeLanguageButton, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM, 10, 0, 10, 76));
...
//            }
    ...
    public class EGLThread extends DispatchQueue {
        ...
        private boolean initGL() {
            ...
            loadTexture(R.drawable.intro1, 22); //TGY
