...
public class ChannelIntroActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        whatIsChannelText.setTypeface(AndroidUtilities.getTypeface(null));
        ...
        descriptionText.setTypeface(AndroidUtilities.getTypeface(null));
        ...
        createChannelText.setTypeface(AndroidUtilities.getTypeface(null));
